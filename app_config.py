...
PROJECT_SLUG = 'liveblog-addon'

# Project name to be used in file paths
PROJECT_FILENAME = 'liveblog_addon'

# The name of the repository containing the source
REPOSITORY_NAME = 'liveblog-addon'
...
GOOGLE APPS SCRIPTS
"""
GAS_PROJECT_NAME = 'LiveblogAddon' # Google app scripts addon project name
